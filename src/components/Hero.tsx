      ...
      <div className="container mx-auto px-4 md:px-8 flex flex-col items-center">
        <div className="text-center max-w-4xl mx-auto mb-16">
          <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
            ...
            <span className="text-green-400">Automation</span> Excellence
          </h1>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 w-full max-w-5xl">
          <div className="bg-green-800/50 backdrop-blur-sm p-6 rounded-xl text-center hover:bg-green-800 transition-all duration-300 transform hover:-translate-y-1">
            ...
            <p className="text-gray-300 text-sm">HMI, PLC, DDC, GW, DL</p>
          </div>
          ...
          <div className="bg-green-800/50 backdrop-blur-sm p-6 rounded-xl text-center hover:bg-green-800 transition-all duration-300 transform hover:-translate-y-1">
            ...
            <p className="text-gray-300 text-sm">MCCB, PFC, KWH, PANEL</p>
          </div>
